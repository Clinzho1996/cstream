...
const TV_URL = `https://api.themoviedb.org/3/tv/top_rated?api_key=${API_KEY}&language=en-US`;
    ...
    <TouchableOpacity
      ...
      <View style={{marginLeft: 10, marginTop: 10}}>
        ...
        <View
          ...
          <Text style={{color: '#999999', fontSize: 16}}>Movie Rating:</Text>
          <StarRating
            disabled={true}
    ...
    <View>
      <ScrollView style={styles.container}>
        ...
        <View style={styles.header}>
          <View>
            <Text style={{color: '#c1c1c1'}}>Welcome Dev-Clinton👋</Text>
        ...
        <View
          ...
          <Text style={{color: '#fff', fontSize: 20}}>Popular Movies</Text>
          <TouchableOpacity>
            <Text style={{color: '#ffb43a', fontSize: 16}}>My Ticket</Text>
          </TouchableOpacity>
        </View>
